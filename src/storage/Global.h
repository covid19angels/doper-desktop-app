...
class GlobalStorage:public  QObject
{
    ...
    Q_PROPERTY(QString pluginjson READ pluginjson WRITE setPluginjson NOTIFY pluginjsonChanged)
public:
...
signals:
    ...
    void pluginjsonChanged(QString pluginjson);
...
public slots:
    ...
    void setPluginjson(QString pluginjson)
    {
        if (m_pluginjson == pluginjson)
            return;

        m_pluginjson = pluginjson;
        emit pluginjsonChanged(m_pluginjson);
    }
